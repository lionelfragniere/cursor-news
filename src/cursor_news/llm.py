...
class OllamaLLMClient:
    ...
    def generate_bulletin(self, articles: list[Article], style: StyleSlot, slot_start: datetime) -> BulletinDraft:
        ...
        return self._generate_json(prompt, temperature=0.2, num_predict=2800)
    ...
    def revise_bulletin(
        ...
        revised = self._generate_json(prompt, temperature=0.18, num_predict=2800)
...
Mission:
- Produire un bulletin d'environ 5 à 6 minutes, entre 650 et 900 mots.
...
Mission:
- Produce a five- to six-minute briefing, between 650 and 900 words.
